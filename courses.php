...
<div class="col-sm-9 mt-5">
    <!-----table------>
    <p class="bg-dark text-white p-2" style="background-color: black; color:white; padding:15px; font-size: 20px; font-family: 'robbin';">List of Courses</p>
    <?php
    ...
    <table class="table">
        ...
        <tbody>
           ...
           echo  '<tr>';
               ...
               echo '<td>';
                 echo '
                 <form action="editcourse.php" method="POST" class="dinl">
