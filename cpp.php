...
<body>
    ...
    <h1 style="font-family:Cambria, Cochin, Georgia, Times, 'Times New Roman', serif; text-align: center;">BOOK PREVIEW</h1>
      ...
      <img class="mySlides" src="cpp1.png">
        <img class="mySlides" src="cpp2.jpg">
        <img class="mySlides" src="cpp3.png">
        <img class="mySlides" src="cpp4.png">
        <img class="mySlides" src="cpp5.png">
        <img class="mySlides" src="cpp6.png">
