...
<body>
    ...
    <h1 style="font-family:Cambria, Cochin, Georgia, Times, 'Times New Roman', serif; text-align: center;">BOOK PREVIEW</h1>
      ...
      <img class="mySlides" src="cp1.jpg">
        <img class="mySlides" src="cp2.png">
        <img class="mySlides" src="cp3.png">
        <img class="mySlides" src="cp4.png">
        <img class="mySlides" src="cp5.png">
        <img class="mySlides" src="cp6.png">
